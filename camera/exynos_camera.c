...
struct exynos_camera_preset exynos_camera_presets_galaxys2[] = {
	{
		...
		.params = {
			.preview_size_values = "1280x720,800x480,800x450,720x480,640x480,352x288,320x240,176x144",
...
int exynos_camera_params_apply(struct exynos_camera *exynos_camera)
{
	...
	if (camera_sensor_mode != exynos_camera->camera_sensor_mode) {
		...
		if (camera_sensor_mode == SENSOR_MOVIE) {
			...
			camera_sensor_output_size = ((preview_width & 0xffff) << 16) | (preview_height & 0xffff);
		}
